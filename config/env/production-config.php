<?php
/**
 * WP-Config file for your Production environment.
 * Place environment specific configurations here that will only be used in your Production environment.
...
//
// Copy and paste this snippet-  SetEnv APPLICATION_ENV "production"
