<?php
/**
 * WP-Config file for your Staging environment.
 * Place environment specific configurations here that will only be used in your Staging environment.
...
//
// Copy and paste this snippet-  SetEnv APPLICATION_ENV "staging"
